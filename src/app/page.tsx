    ...
    <div className="bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center">
        ...
        <motion.div 
          ...
          <Link href="/contact" className="inline-block bg-blue-600 text-white font-bold py-3 sm:py-3 px-4 sm:px-6 rounded-full hover:bg-blue-700 transition duration-300 text-base sm:text-lg">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <motion.div 
              ...
              <Link href="/services" className="inline-block bg-white text-blue-700 font-bold py-3 sm:py-4 px-4 sm:px-8 rounded-full hover:bg-gray-100 transition-transform transform hover:scale-105 duration-300 flex items-center shadow-md">
      ...
      <section className="relative py-20 bg-gradient-to-r from-gray-800 to-gray-900 text-white">
        ...
        <div className="relative z-20 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div 
            ...
            <Link href="/about" className="inline-block bg-white text-blue-600 font-bold py-3 sm:py-4 px-4 sm:px-6 lg:px-8 rounded-full hover:bg-gray-200 transition duration-300 text-base sm:text-lg whitespace-normal text-center max-w-xs sm:max-w-none">
      ...
      <section className="relative bg-gradient-to-r from-blue-700 to-blue-900 text-white py-20">
        ...
        <motion.div 
          ...
          <p className="text-lg md:text-xl text-gray-200 mb-10 max-w-3xl mx-auto">Ready to secure and scale your business? We provide the expertise and solutions to help you achieve your goals.</p>
                      <Link href="/contact" className="inline-block bg-white text-blue-600 font-bold py-3 sm:py-4 px-6 sm:px-10 rounded-full hover:bg-gray-200 transition-transform transform hover:scale-105 duration-300 text-base sm:text-lg inline-flex items-center shadow-lg">
