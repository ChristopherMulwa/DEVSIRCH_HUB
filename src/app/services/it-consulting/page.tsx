    ...
    <div className="bg-white dark:bg-gray-900">
      ...
      <section className="bg-gray-50 pt-24 pb-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800">IT Consulting & Technical Support</h1>
          <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
            Your trusted partner for strategic guidance and reliable technical assistance.
          </p>
        </div>
      </section>
