...
const GRCPage = () => {
  ...
  const tabContent = {
    governance: {
      ...
      description: 'We establish clear governance structures that align with your business objectives, ensuring accountability, transparency, and strategic alignment across your organization.',
      image: '/public/images/logos/direct-mail.png',
      features: [
    ...
    risk: {
      ...
      description: 'Our experts help you identify, assess, and mitigate risks before they impact your business. We provide a comprehensive view of your risk landscape to enable informed decision-making.',
      image: '/public/images/logos/direct-mail.png',
      features: [
    ...
    compliance: {
      ...
      description: 'Stay ahead of the complex and ever-changing regulatory landscape. We help you meet your compliance obligations, from data privacy laws like GDPR to industry-specific standards.',
      image: '/public/images/logos/direct-mail.png',
      features: [
            ...
            <div className="md:w-2/3">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="bg-gray-50 rounded-xl shadow-xl p-8"
                >
                  <h3 className="text-3xl font-bold mb-4">{tabContent[activeTab].title}</h3>
                  <p className="text-gray-600 text-lg mb-8">{tabContent[activeTab].description}</p>
